...
const PizzaBuilderRightSection = () => {
    return (
        <>
            <div className="bg-blue-50   box-border flex flex-col md:flex-grow-[3] basis-0">
                ...
                <ul className='mt-5 mx-6  flex overflow-auto gap-x-3 p-2 md:px-0 md:pt-0 pb-5 md:grid md:gap-y-4 md:gap-x-3 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 bg-gradient-to-l from-[#00000033]  to-20% rounded-3xl  md:bg-none scrollbar-none' style={{backdropFilter:"opacity(0.5)"}}>
                    <ListItemImageTitle image={Basil} title="Basil" color="#00ff00ff" className='peer-checked:bg-green-100 peer-checked:border-green-500' />
                    <ListItemImageTitle image={Mushroom} title="Mushroom" color="#00000077" className='peer-checked:bg-gray-100  peer-checked:border-gray-500 ' />
                    <ListItemImageTitle image={Pineapple} title="Pineapple" color="#fff000ff" className='peer-checked:bg-yellow-100  peer-checked:border-yellow-500 ' />
                    <ListItemImageTitle image={Tomato} title="Tomato" color="#ff0000ff" className='peer-checked:bg-red-100  peer-checked:border-red-500 ' />
                    <ListItemImageTitle image={Olive} title="Olive" color="#000000aa" className='peer-checked:bg-gray-100  peer-checked:border-gray-500 ' />
                </ul>
                <div className='mt-auto relative px-5 pb-5 text-2xl active:scale-95 transition-all'>
                    <button className="w-full inline-flex justify-center items-center mt-3 md:mt-10 px-8 py-3 group relative overflow-hidden rounded-lg shadow-lg ring-2  bg-gray-50 hover:ring-black hover:bg-gradient-to-r hover:from-blue-400 hover:from-50% " href="">
                        ...
                        <span className="font-medium transition-all group-hover:me-4 text-xl">
                            🍕 Place order 
